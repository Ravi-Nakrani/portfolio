...
export const metadata: Metadata = {
  ...
  description: `${personal.name} is a Full-Stack Developer based in ${personal.location} with ${personal.yearsOfExperience}+ years of experience building scalable web applications and real-time distributed systems using TypeScript, Node.js, NestJS, React, and Next.js.`,
  ...
  openGraph: {
    ...
    description: `${personal.name} is a Full-Stack Developer based in ${personal.location} with ${personal.yearsOfExperience}+ years of experience building scalable web applications and real-time distributed systems.`,
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: `${personal.name} — Full-Stack Developer Portfolio`,
      },
    ],
  },
  twitter: {
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: `Personal portfolio and engineering showcase of ${personal.name}, Full-Stack Developer based in ${personal.location}.`,
      publisher: {
        "@id": `${SITE_URL}/#person`,
      },
      inLanguage: "en-US",
    },
    {
      ...
      url: SITE_URL,
      name: `${personal.name} — Full-Stack Developer Portfolio`,
      isPartOf: {
        "@id": `${SITE_URL}/#website`,
      },
      about: {
